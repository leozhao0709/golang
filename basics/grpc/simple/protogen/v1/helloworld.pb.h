...
#ifndef GOOGLE_PROTOBUF_INCLUDED_v1_2fhelloworld_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_v1_2fhelloworld_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_v1_2fhelloworld_2eproto
...
struct TableStruct_v1_2fhelloworld_2eproto {
...
/* @@protoc_insertion_point(class_definition:protogen.v1.pb.HelloResponse) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "protogen.v1.pb.HelloResponse"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:protogen.v1.pb.HelloResponse)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_v1_2fhelloworld_2eproto;
};
// -------------------------------------------------------------------

class HelloRequest final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:protogen.v1.pb.HelloRequest) */ {
 public:
 ...
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "protogen.v1.pb.HelloRequest"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:protogen.v1.pb.HelloRequest)
 private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<
...
inline const std::string& HelloRequest::name() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:protogen.v1.pb.HelloRequest.name)
...
inline PROTOBUF_ALWAYS_INLINE void HelloRequest::set_name(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:protogen.v1.pb.HelloRequest.name)
}
inline std::string* HelloRequest::mutable_name() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:protogen.v1.pb.HelloRequest.name)
  return _s;
}
...
inline std::string* HelloRequest::release_name() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:protogen.v1.pb.HelloRequest.name)
...
inline void HelloRequest::set_allocated_name(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:protogen.v1.pb.HelloRequest.name)
}
...
inline const std::string& HelloResponse::message() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:protogen.v1.pb.HelloResponse.message)
...
inline PROTOBUF_ALWAYS_INLINE void HelloResponse::set_message(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:protogen.v1.pb.HelloResponse.message)
}
inline std::string* HelloResponse::mutable_message() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:protogen.v1.pb.HelloResponse.message)
  return _s;
}
...
inline std::string* HelloResponse::release_message() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:protogen.v1.pb.HelloResponse.message)
...
inline void HelloResponse::set_allocated_message(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:protogen.v1.pb.HelloResponse.message)
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_v1_2fhelloworld_2eproto_2epb_2eh
